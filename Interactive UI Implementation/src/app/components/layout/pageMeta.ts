...
const PAGE_TITLES: Record<string, string> = {
  ...
  '/admin/dashboard?tab=reports': 'Report builder',
  ...
  '/manager/dashboard?tab=reports': 'Report builder',
...
const PAGE_DESCRIPTIONS: Record<string, string> = {
  ...
  '/admin/dashboard?tab=reports': 'Build and export institutional research reports in PDF, Excel, CSV, HTML, or JSON.',
  '/admin/reports': 'Build and export institutional research reports in PDF, Excel, CSV, HTML, or JSON.',
  ...
  '/manager/dashboard?tab=reports': 'Build and export institutional research reports in PDF, Excel, CSV, HTML, or JSON.',

...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const ctxValue = useMemo(() => ({
    ...
    user, researchers, research, pendingResearchers, pendingFunders, pendingPublications,
    collaborationRequests, fundingRequests, funderInterests, funderRfps,
    chatMessages, notifications, systemAnnouncements, chatDrawerOpen, chatPeerId,
    processingJobs, dataQualityMetrics, dataSources,
    auditLogs, userSessions, userPermissions, securitySettings,
    reports, reportData, dashboards,
  ]);

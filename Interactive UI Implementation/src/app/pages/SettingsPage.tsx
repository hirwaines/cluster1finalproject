...
import { User, Shield, Globe, BarChart3, LogOut, Palette, Bell, Save, Loader2 } from 'lucide-react';
...
export function SettingsPage() {
  ...
  const sections = [
    ...
    { id: 'language', icon: Globe, label: 'Language & region', description: 'English (UK) · Africa/Kigali' },
            ...
            <div>
              ...
              <Select defaultValue="africa-kigali">
                ...
                <SelectContent>
                  ...
                  <SelectItem value="america-new-york">America/New York (ET)</SelectItem>

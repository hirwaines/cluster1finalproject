...
export function ResearcherDashboard() {
  ...
  const { user, research, researchers, logout } = useApp();
    ...
    <div style={{ padding: '2rem' }}>
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">
            Welcome back, {user.name.split(' ')[1] || user.name}! ðŸ‘‹
          </h1>
        ...
        <div className="grid grid-cols-3 gap-8">
          ...
          <div className="col-span-2 space-y-6">
            ...
            <Card className="p-6 bg-[#1E40AF] text-white">
                ...
                {potentialCollaborators.map(researcher => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <Avatar className="w-12 h-12 bg-[#1E40AF] flex items-center justify-center text-white font-bold flex-shrink-0">
